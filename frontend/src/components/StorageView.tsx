...
export function StorageView({ variant, title, receipts, totalAmount, summaryRows }: StorageViewProps) {
    ...
    <div className="page">
      ...
      <div className="page__body">
        ...
        <div className="btn-row">
          ...
          <button className={`btn ${secondaryClass}`}>새로고침</button>
        </div>
        ...
        <div>
          ...
          {filtered.length === 0 && <div className="center-note">해당 월의 거래 내역이 없습니다.</div>}
        </div>
      </div>
    </div>
  );
